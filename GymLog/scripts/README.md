...
| What                                                  | Where                                                                                                                                                                                              |
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The rebuild/install script                            | `GymLog/scripts/refresh-device-build.sh` (this repo)                                                                                                                                               |
| The `launchd` job definition                          | `GymLog/scripts/com.nikhilnathwani.gymlog.refresh.plist` (this repo) — symlinked from `~/Library/LaunchAgents/com.nikhilnathwani.gymlog.refresh.plist`, which is where macOS actually looks for it |
